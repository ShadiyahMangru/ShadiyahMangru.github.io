...
$("#BinDecOptions").append("Select Study Option:<br><button class='siteButton' id='binToDecShow'>Review Binary to Decimal Conversion</button><button class='siteButton' id='decToBinShow'>Review Decimal to Binary Conversion</button><button class='siteButton' id='binToDecPracticeShow'>Binary to Decimal Conversions Practice</button><button class='siteButton' id='decToBinPracticeShow'>Decimal to Binary Conversions Practice</button><br><br>");    
    
$("#binToDec").append("EXAMPLE: Convert the <span class='highlight'>Binary</span> number 1101101 to its Decimal equivalent.<div id='block'>1101101 = (1)*2<sup>6</sup> + (1)*2<sup>5</sup> + (0)*2<sup>4</sup> + (1)*2<sup>3</sup> + (1)*2<sup>2</sup> + (0)*2<sup>1</sup> + (1)*2<sup>0</sup>= 64 + 32 + 0 + 8 + 4 + 0 + 1=  109<br>Therefore<div class='row'><div class='column'><table class='BDtable'><caption>BINARY</caption><thead><tr><th scope='col'></th><th scope='col'>2<sup>6</sup></th><th scope='col'>2<sup>5</sup></th><th scope='col'>2<sup>4</sup></th><th scope='col'>2<sup>3</sup></th><th scope='col'>2<sup>2</sup></th><th scope='col'>2<sup>1</sup></th><th scope='col'>2<sup>0</sup></th></tr></thead><tbody><tr><th scope='row'>Bit</th><td>1</td><td>1</td><td>0</td><td>1</td><td>1</td><td>0</td><td>1</td></tr></tbody></table></div><div class='column'><h3>=</h3></div><div class='column'><table class='BDtable'><caption>DECIMAL</caption><thead><th scope='column'></th><th>10<sup>2</sup></th><th>10<sup>1</sup></th><th>10<sup>0</sup></th></thead><tbody><tr><th scope='row'>Digit</th><td>1</td><td>0</td><td>9</td></tr></tbody></table></div></div></div><br><br>GENERALIZED STEPS TO SOLVE:<ol><li>Multiply each bit of the binary number by 2 to the appropriate power and sum these products.</li><li>The final sum is the converted decimal value.</li></ol>");    
