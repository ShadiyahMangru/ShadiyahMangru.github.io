...
$("#BinDecOptions").append("Select Study Option:<br><button class='siteButton' id='binToDecPracticeShow'>Binary to Decimal Conversions Practice</button><button class='siteButton' id='decToBinPracticeShow'>Decimal to Binary Conversions Practice</button><button class='siteButton' id='binToDecShow'>Review Binary to Decimal Conversion</button><button class='siteButton' id='decToBinShow'>Review Decimal to Binary Conversion</button><br><br>");    
