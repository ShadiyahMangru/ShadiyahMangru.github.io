...
memory.controller("MemoryCtrl", function ($scope) {
    ...
    $scope.contentsHeader = "Advance to your final training exercise by using your short-term memory skills and mental agility to identify all of the matching image pairs.  Flip two (ideally identical) cards, note feedback and press 'OK'.  Repeat this process until you have identified all of the pairs and no cards remain on the gameboard.";
